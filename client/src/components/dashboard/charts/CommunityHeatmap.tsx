      ...
      <ResponsiveContainer width="100%" height="100%">
        <ScatterChart margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
          ...
          <Tooltip 
            ...
            formatter={(_value: number | string | readonly (string | number)[] | undefined, _name: number | string | undefined, props: { payload?: { name?: string } }) => [props.payload?.name || 'Unknown', 'Location']}
          />
